                ...
                <Grid>
                  <a>
                    <Card
                      ...
                      variant="bordered"
                      style={{ boxShadow: '1px 1px 10px #A020F0', backgroundColor:'black' }}
                    >
                      ...
                      <Card.Body sm key={i}>
                        ...
                        <Text style={{ color: '#A020F0'}}>{nft.desc}</Text>
                        <Input
                          size="sm"
                          css={{
                            marginTop: "$2",
